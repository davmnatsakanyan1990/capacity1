...
// Configration 
	...
	$load  =  new loader();	
	$objPages = $load->includeclasses('pages');
	$label = "pages";
	$dclass   =  new  database();
	$gnrl =  new general;
...
$load->includeother('left_sidebar');?>
  ...
  <?php  if (isset($_REQUEST['script'])  ||  $_REQUEST['script'] ==  'add' ||  $_REQUEST['script'] == 'edit'){
            ...
            <div class="portlet-body form">
              ...
              <form name="<?php echo $label;?>" id="<?php echo $label;?>" method="post"  enctype="multipart/form-data">
                ...
                <div class="control-group">
                  <label class="control-label valiclrBold">Cms Title *</label>
                  <div class="controls">
                  <input type="text" maxlength="150" name="cms_name"  id= "cms_name" size=30 value="<?php echo $row[0]['cms_name'];?>" class="validate[required] span6 m-wrap">
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                  <textarea name="cms_desc" id="cms_desc" class="span12 ckeditor m-wrap" rows="6"><?php echo $row[0]['cms_desc'];?></textarea>
                  </div>
                </div>
                
                <div class="control-group">
                  <label class="control-label ">Cms External Url </label>
                  <div class="controls">
                  <input type="text"  name="cms_external_url"  id= "cms_external_url" size=30 value="<?php echo $row[0]['cms_external_url'];?>" class="span6 m-wrap validate[custom[url]]">
                  </div>
                </div>
                
                
                <div class="control-group">
                  <label class="control-label valiclrBold">Display Position *</label>
                  <div class="controls">
                 <select name="cms_position" class="validate[required] span6 m-wrap" id="cms_position">
                    <option value="" selected="selected" >Select Position</option>
                    <option value="About"  <?php if($row[0]['cms_position']=='About') {echo 'selected="selected"';} ?>  >About</option>
                    <option value="Support/Help"  <?php if($row[0]['cms_position']=='Support/Help') {echo 'selected="selected"';} ?> >Support/Help</option>
                    <option value="Other"  <?php if($row[0]['cms_position']=='Other') {echo 'selected="selected"';} ?> >Other</option>
                    <option value="Site"  <?php if($row[0]['cms_position']=='Site') {echo 'selected="selected"';} ?> >Site</option>
                 </select>                 
                  </div>
                </div>
                
                <div class="control-group">
                  <label class="control-label valiclrBold">Display Order *</label>
                  <div class="controls">
                  <input type="text"  name="cms_display_order"  id= "cms_display_order" size=30 value="<?php echo $row[0]['cms_display_order'];?>" class="validate[required,custom[integer]] span6 m-wrap">
                  </div>
                </div>
                
                <div class="control-group">
                  <label class="control-label ">Cms Meta Title </label>
                  <div class="controls">
                  <input type="text"  name="cms_meta_title"  id= "cms_meta_title" size=30 value="<?php echo $row[0]['cms_meta_title'];?>" class="span6 m-wrap">
                  </div>
                </div>
                
                <div class="control-group">
                  <label class="control-label ">Cms Meta Keywords </label>
                  <div class="controls">
                  <textarea name="cms_meta_keyword" id="cms_meta_keyword" class="span6  m-wrap" rows="6"><?php echo $row[0]['cms_meta_keyword'];?></textarea>
                  </div>
                </div>
                
                <div class="control-group">
                  <label class="control-label ">Cms Meta Description </label>
                  <div class="controls">
                  <textarea name="cms_meta_description" id="cms_meta_description" class="span6  m-wrap" rows="6"><?php echo $row[0]['cms_meta_description'];?></textarea>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                 <select name="cms_publish" class="validate[required] span6 m-wrap" id="cms_publish">
                                    <option value="" selected="selected" >Select Status</option>
                                    <option value="1"  <?php if($row[0]['cms_publish']=='1') {echo 'selected="selected"';} ?>  >Active</option>
                                    <option value="0"  <?php if($row[0]['cms_publish']=='0') {echo 'selected="selected"';} ?> >Deactive</option>
                 </select>                 
                  </div>
                </div>
    ...
    <?php 
			...
			?>
            <span><a href="<?php echo $label;?>.php?script=edit&id=<?php echo $rows['cms_id'];?>"><img src="<?php echo  IMAGEPATH; ?>edit-icon.png"  name="Edit" alt=""></a> </span> 
