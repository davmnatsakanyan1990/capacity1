<?php
	class location extends general {
		...
		public  function updateData(){
			...
			// Update Records in database starts
				...
				{	
					...
					parent::update($this->_tableName,$ins," location_id = '".$id."'");					
					return('1');					
				}
		...
		public function getData(){
				$id = $_REQUEST['id'];	
				$row = parent::select('*',$this->_tableName," AND location_id = '".$id."'");				
				return($row);			
		}
		// Get Info Data
		public function getInfo($id){
				//$id = $_REQUEST['id'];	
				$page_info =  parent::select('*',$this->_tableName," AND location_id = '".$id."'");
				return($page_info);			
		}
		//Get info by Field
		...
		public function deactiveRecode(){
			$id = $_REQUEST['id'];			
			// Update Records in database starts
			$ins = array("location_status"=>'inactive',);
			parent::update($this->_tableName,$ins,"location_id = '".$id."'");
			return  ('1');
		}
		// Active  Recode
		public  function  activeRecode(){
			...
			$id = $_REQUEST['id'];			
			// Update Records in database starts
			$ins = array("location_status"=>'active',);
			parent::update($this->_tableName,$ins,"location_id = '".$id."'");
			return  ('1');
		}
		//  Delete Recode
		public function  deleteRecode($idD = ''  ){
			...
			parent::delete($this->_tableName," location_id = '".$id."'");			
			return  ('1');	
		}
