        ...
        function getPagesLinks() {
            ...
            $html = '';
                ...
                if ($this_page > 1) {
                        ...
                        $html .= "\n<a href=\"#beg\" title=\"first page\" onclick=\"javascript: document.$this->form.limitstart.value=0; document.$this->form.submit();return false;\" style='color:black'>&lt;&lt; First</a>";
                        $html .= "\n<a href=\"#prev\"  title=\"previous page\" onclick=\"javascript: document.$this->form.limitstart.value=$page; document.$this->form.submit();return false;\">&lt; Prev</a>";
                } else {
                ...
                for ($j=$start_loop; $j <= $stop_loop; $j++) {
                        $page = ($j - 1) * $this->limit;
                        if ($j == $this_page) {
                                $html .= "\n<span class=\"pagenav\"> $j </span>";
                        } else {
                                $html .= "\n<a href=\"#$j\" onclick=\"javascript: document.$this->form.limitstart.value=$page; document.$this->form.submit();return false;\"><strong>$j</strong></a>";
                        }
                }
                ...
                if ($this_page < $total_pages) {
                        ...
                        $html .= "\n<a href=\"#next\"  title=\"next page\" onclick=\"javascript: document.$this->form.limitstart.value=$page; document.$this->form.submit();return false;\"> Next &gt;</a>";
                        $html .= "\n<a href=\"#end\"  title=\"end page\" onclick=\"javascript: document.$this->form.limitstart.value=$end_page; document.$this->form.submit();return false;\"> Last &gt;&gt;</a>";
                } else {
