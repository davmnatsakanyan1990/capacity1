...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      nextLabel: 'NEXT',
      prevLabel: 'PREV',
      skipLabel1: "Don't show me again",
      skipLabel: 'Close',
      doneLabel: 'Done',
  ...
  function _setHelperLayerPosition(helperLayer) {
    ...
    if(helperLayer) {
      ...
      if(!this._introItems[this._currentStep]) return;
      if(this._currentStep == '0' && pathname == '/capacity/userlist'){
  ...
  function _showElement(targetElement) {
    ...
    if(oldHelperLayer != null) {
      ...
      //skip1 button
      var skipTooltipButton1 = document.createElement('a');
      skipTooltipButton1.className = 'introjs-button introjs-skipbutton1';
      skipTooltipButton1.href = 'javascript:void(0);';
      skipTooltipButton1.innerHTML = this._options.skipLabel1;

      skipTooltipButton1.onclick = function() {
        if (self._introItems.length - 1 == self._currentStep && typeof (self._introCompleteCallback) === 'function') {
          self._introCompleteCallback.call(self);
        }
        _exitIntro.call(self, self._targetElement);
 ...
 var tooltipButtonsLayer = tooltipLayer.querySelector('.introjs-tooltipbuttons');
      ...
      tooltipButtonsLayer.appendChild(skipTooltipButton1);
    ...
    if (this._currentStep == 0) {
      ...
      skipTooltipButton.className = 'introjs-button introjs-skipbutton displayTopright';
      prevTooltipButton.className = 'introjs-button introjs-prevbutton';
